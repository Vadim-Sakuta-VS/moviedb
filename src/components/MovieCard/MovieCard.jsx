    ...
    <Card className='mb-4 movie-card flex-grow-1'>
      ...
      <Card.Body>
        ...
        <Container className='p-0 mb-2'>
          ...
          <Col className='p-0'>{movie.overview}</Col>
        </Container>
        <Container className='p-0 mb-2'>
          <Row className='ml-0 align-items-center'>
            <Col className='p-0 m-0 font-weight-bold h5'>Vote average:</Col>
        ...
        <Container className='p-0 mb-2'>
          <Row className='ml-0 align-items-center'>
            <Col className='p-0 m-0 font-weight-bold h5'>Vote count:</Col>
            <Col className='p-0'>{movie.vote_count}</Col>
          </Row>
        </Container>
        <Container className='p-0'>
          <Row className='ml-0 align-items-center'>
            <Col className='p-0 m-0 font-weight-bold h5'>Release date:</Col>
