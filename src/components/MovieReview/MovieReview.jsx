...
const MovieReview = ({
  ...
  const localeTimeCreated = dateUpdated.toLocaleTimeString().slice(0, 5);
  const localeTimeUpdated = dateUpdated.toLocaleDateString().slice(0, 5);
    ...
    <Alert variant='secondary'>
      ...
      <Modal size='lg' show={isShowModal} onHide={handleClose}>
        <Modal.Header closeButton>
          <Modal.Title>Review from '{author.username}'</Modal.Title>
        </Modal.Header>
